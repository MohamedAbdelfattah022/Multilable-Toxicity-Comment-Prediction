  ...
  return (
    <div className='flex items-center justify-between max-w-7xl mx-auto h-full py-8 px-8'>
        ...
        <div className='gap-5 flex items-center'>
            <Link href='/About' className='font-semibold hover:-translate-y-1 transition-all'>About</Link>
            <Link href='/PrivacyPolicy' className='font-semibold hover:-translate-y-1 transition-all'>Privacy Policy</Link>
            <Link href="https://github.com/MohamedAbdelfattah022/Multilable-Toxicity-Comment-Prediction/tree/master" target='_blank'>
